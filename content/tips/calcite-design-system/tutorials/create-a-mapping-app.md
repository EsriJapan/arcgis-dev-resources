...
次に、ナビゲーション ロゴの [`heading`](https://developers.arcgis.com/calcite-design-system/components/navigation-logo/#api-reference-properties-heading) と情報パネルに Web マップのコンテンツを反映させます。
