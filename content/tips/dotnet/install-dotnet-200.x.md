...
このインストール ガイドでは、ArcGIS Maps SDK for .NET のインストールとセットアップ手順を紹介します。
...
* ArcGIS Maps SDK for .NET がサポートする最新の動作環境については [system requirements](https://developers.arcgis.com/net/reference/system-requirements/) をご覧ください。
