...
<img src="https://apps.esrij.com/arcgis-dev/guide/img/install-jsapi/Install.PNG" width="600px">
...
1. `C:\inetpub\wwwroot\arcgis_js_api\library\4.18\dojo\dojo.js` をテキスト エディターで開きます。
1. `[HOSTNAME_AND_PATH_TO_JSAPI]` を検索して `www.example.com/arcgis_js_api/library/4.18/` に置き換えます。
1. `C:\inetpub\wwwroot\arcgis_js_api\library\4.18\init.js` をテキスト エディターで開きます。
1. `[HOSTNAME_AND_PATH_TO_JSAPI]` を検索して `www.example.com/arcgis_js_api/library/4.18/` に置き換えます。
