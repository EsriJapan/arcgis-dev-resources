...
[グリッド ベースの変換](https://developers.arcgis.com/kotlin/geometry-and-spatial-reference/spatial-reference/#grid-based-transformations)を使用している場合は、ダウンロード ページからサポートする [Projection Engine ファイル](https://developers.arcgis.com/kotlin/downloads/#projection-engine-data)をダウンロードしてください。座標系、投影法、測地系変換の操作の詳細については、[Spatial references](https://developers.arcgis.com/kotlin/geometry-and-spatial-reference/spatial-reference/) のトピックを参照してください。
