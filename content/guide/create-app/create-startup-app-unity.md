...
3. [ヒエラルキー（Hierarchy）]ウィンドウで、**Geometry** のゲーム オブジェクトを選択し、右クリックしてコンテキスト メニューから[削除（Delete）]を選択して、シーンから削除します。
    <img src="https://apps.esrij.com/arcgis-dev/guide/img/unity-startup-app/remove-geometry.png" width="650px">
...
3. [Origin Position] セクションでは、GIS シーンの中心を座標と Spatial Reference Well-Known ID (WKID) で設定できます。チュートリアルでは、パラメーターを以下の値に設定します。

    * Longitude : 139.745723
    * Latitude : 35.659041
    * Altitude : 0
    * Spatial Reference WKID (Horizontal): 4326
