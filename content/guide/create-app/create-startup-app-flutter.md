...
2. 新しいメソッド内で final 変数 `map` を定義し、ArcGIS 地形図ベースマップ スタイルを使用して [`ArcGISMap`](https://developers.arcgis.com/flutter/api-reference/reference/arcgis_maps/ArcGISMap-class.html) として初期化します。
